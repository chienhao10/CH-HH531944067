    ...
    public static class Orbwalking
    {
        ...
        public class Orbwalker
        {
            ...
            public Orbwalker(Menu attachToMenu)
            {
                ...
                /* Misc options */
                SubMenu["Orbwalker2"] = MainMenu.AddMenu("薇恩独立走砍", "Key Vayne");
                SubMenu["Orbwalker2"].Add("PriorizeFarm", new CheckBox("优先尾兵后骚扰", true));
                SubMenu["Orbwalker2"].Add("AttackWards", new CheckBox("自动攻击眼", false));
                SubMenu["Orbwalker2"].Add("AttackPetsnTraps", new CheckBox("自动攻击陷阱/守卫", true));
                SubMenu["Orbwalker2"].Add("Smallminionsprio", new CheckBox("清野优先小怪  ", false));

                /* Missile check */
                SubMenu["Orbwalker2"].Add("MissileCheck", new CheckBox("飞行物体探测（LUX的Q类）", true));

                /*Load the menu*/
                SubMenu["Orbwalker2"].Add
                    ("LastHit", new KeyBind("尾兵", false, KeyBind.BindTypes.HoldActive, 'X'));

                SubMenu["Orbwalker2"].Add
                    ("Farm", new KeyBind("E骚扰", false, KeyBind.BindTypes.HoldActive, 'C'));

                SubMenu["Orbwalker2"].Add
                    ("Clear", new KeyBind("清野", false, KeyBind.BindTypes.HoldActive, 'V'));

                SubMenu["Orbwalker2"].Add
                    ("Combo", new KeyBind("连招", false, KeyBind.BindTypes.HoldActive, 32));
