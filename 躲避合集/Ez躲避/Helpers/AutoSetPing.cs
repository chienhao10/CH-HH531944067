...
namespace ezEvade
{
    class AutoSetPing
    {
        ...
        public AutoSetPing(Menu mainMenu)
        {
            ...
            Menu autoSetPingMenu = mainMenu.IsSubMenu ? mainMenu.Parent.AddSubMenuEx("自动设置延迟", "AutoSetPingMenu") : mainMenu.AddSubMenuEx("自动设置延迟", "AutoSetPingMenu");
            autoSetPingMenu.Add("AutoSetPingOn", new CheckBox("自动设置延迟", true));
            autoSetPingMenu.Add("AutoSetPercentile", new Slider("自动设置百分比", 75, 0, 100));
