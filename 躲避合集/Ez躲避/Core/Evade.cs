     ...
     //   private static bool GetDangerPoint = false;
        ...
        private void Game_OnGameLoad(EventArgs args)
        {
            ...
            try
            {
                ...
                menu = MainMenu.AddMenu("EZ躲避", "ezEvade");
                ObjectCache.menuCache.AddMenuToCache(menu);

                Menu mainMenu = menu.AddSubMenuEx("核心", "Main");
                mainMenu.Add("DodgeSkillShots",new KeyBind("躲避指向性技能", true, KeyBind.BindTypes.PressToggle, 'K'));
                mainMenu.Add("ActivateEvadeSpells",new KeyBind("使用技能躲避", true, KeyBind.BindTypes.PressToggle, 'K'));
                mainMenu.AddSeparator();
                mainMenu.Add("DodgeDangerous", new CheckBox("只躲避危险的", false));
                mainMenu.Add("ChaseModeMinHP", new CheckBox("检查血量 %(追击模式)"));
                ...
                var sliderEvadeMode = mainMenu.Add("躲避模式", new Slider("平滑", 0, 0, 2));
                var modeArray = new[] { "平滑", "快速", "非常平滑" };
                ...
                miscMenu.Add("ContinueMovement", new CheckBox("继续最后一次的移动", false));
                ...
                limiterMenu.Add("DodgeInterval", new Slider("躲避曲线", 0, 0, 2000));
                ...
                fastEvadeMenu.Add("RejectMinDistance", new Slider("体积碰撞距离缓冲", 10, 0, 100));
                ...
                bufferMenu.Add("MinComfortZone", new Slider("英雄最短路程", 1000, 0, 1000));
